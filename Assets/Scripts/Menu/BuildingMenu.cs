...
{   
    ...
    //Not workint atm :C
     ...
     private ResourcesController _resourcesController;
   public ResourcesStorageController ResourcesStorageController;
    private ResourcesController _resourcesController;
   ...
   /    GetReferences();       
    ...
    private void GetReferences()
    {
        ...
        _resourcesController = GameObject.FindGameObjectWithTag(Tags.RESOURCES_CONTROLLER).gameObject.GetComponent<ResourcesController>();
        ResourcesStorageController = GetComponents<ResourceData>();
        // _resourcesController.UseResource(resourceType, resourceAmount);
    }
          //Resources = ResourcesStorageController.resourceData;
